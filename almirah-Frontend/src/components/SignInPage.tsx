...
export const SignInPage = ({ signUp, setSignUp }: signupProps) => {
    ...
    return <div className="bg-white w-86 max-h-132 border-2 shadow-[4px_4px_0px_#000] rounded-sm pb-2">
        <div className="pt-8">
            <p className="font-semibold font-clashdisplay text-3xl text-center">Welcome Back</p>
            <p className="font-clashdisplay text-center text-xs text-slate-600 ">Take a look at your Almirah</p>
        </div>
        ...
        <div className="text-sm font-clashdisplay pl-16 pt-6 space-x-1">
            ...
            <span className="font-semibold cursor-pointer" onClick={() => { setSignUp(!signUp) }}>Sign up</span>
        </div>
    </div>
}