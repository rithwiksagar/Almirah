...
export function SideBar({ }) {
    ...
    return <div className="h-screen w-12 bg-cream border-r md:w-24">
        ...
        <div className="pt-10 text-4xl md:pt-20 space-y-64">
            <ul className="space-y-8">
                {sideBarItems.map(item => <li className="w-fit mx-auto p-2 border-2 rounded-md bg-white cursor-pointer
            ...
            <div className="w-fit mx-auto p-2 border-2 rounded-md bg-white cursor-pointer
                        shadow-[4px_4px_0px_#000] active:shadow-none active:translate-x-1
                      active:translate-y-1 transition-all duration-300 text-sm md:text-2xl" onClick={handleClose}>
                <PiSignOutBold />
            </div>
        </div>
